		...
		/***/ function (module, exports, __webpack_require__) {
			...
			Webflow.validClick = touch
				? function (clickTarget) {
						return (
							clickTarget === touchTarget || $.contains(clickTarget, touchTarget)
						);
				  }
				: function () {
						return true;
				...
				(module.exports = function () {
					...
					function isPolyfilledFocusEvent(e) {
						...
						return (
							...
							(/^input$/i.test(tag) &&
								/^(button|reset|radio|checkbox)$/i.test(el.type) &&
								!el.disabled) || // (D)
							...
							$doc.on(
								...
								function (evt) {
									$(evt.target)
										.siblings(customControlClassName)
										.removeClass(
											''.concat(FOCUSED_CLASS, ' ').concat(FOCUSED_VISIBLE_CLASS)
										);
								}
							);
						});
...
Webflow.require('ix').init([
	...
	{
		slug: 'fade-on-scroll-1',
		name: 'fade on scroll 1',
		value: {
			style: { opacity: 0, x: '0px', y: '10px', z: '0px' },
			triggers: [
				{
	...
	{
		slug: 'fade-on-scroll-2',
		name: 'fade on scroll 2',
		value: {
			style: { opacity: 0, x: '0px', y: '10px', z: '0px' },
			triggers: [
				{
