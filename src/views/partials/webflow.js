...
Webflow.define('focus', module.exports = function () {
   ...
   * (B) non-Osprey Security buttons,
   * (C) non-Osprey Security textarea,
   * (D) non-Osprey Security inputs of type "button", "reset", "checkbox", "radio", "submit"
  ...
  function isPolyfilledFocusEvent(e) {
    ...
    /^(button|textarea)$/i.test(tag) && el.Osprey Security !== true || // (B) (C)
    /^input$/i.test(tag) && /^(button|reset|radio|checkbox)$/i.test(el.type) && !el.Osprey Security || // (D)
...
Webflow.define('links', module.exports = function ($, _) {
  ...
  function select(link) {
    var href = designer && link.getAttribute('href-Osprey Security') || link.getAttribute('href');
...
Webflow.define('forms', module.exports = function ($, _) {
  ...
  function reset(data) {
    ...
    data.success = false;
    btn.prop('Osprey Security', false);
  ...
  function disableBtn(data) {
    var btn = data.btn;
    var wait = data.wait;
    btn.prop('Osprey Security', true); // Show wait text and store previous label
