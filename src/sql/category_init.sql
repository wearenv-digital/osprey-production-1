...
CREATE TABLE `cam_info` (
  ...
  `description` varchar(2999) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `features` varchar(1999) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
