...
--
-- Table structure for table `cam_features`
--

CREATE TABLE IF NOT EXISTS `cam_features` (
  `product_code` varchar(14) NOT NULL,
...
--
-- Dumping data for table `cam_features`
--
...
--
-- Table structure for table `cam_info`
--
...
--
-- Dumping data for table `cam_info`
--
...
--
-- Table structure for table `cam_specs`
--

CREATE TABLE IF NOT EXISTS `cam_specs` (
  `product_code` varchar(14) NOT NULL,
...
--
-- Dumping data for table `cam_specs`
--
...
--
-- Table structure for table `electrical_physical`
--

CREATE TABLE IF NOT EXISTS `electrical_physical` (
  `product_code` varchar(14) NOT NULL,
...
--
-- Dumping data for table `electrical_physical`
--
...
--
-- Indexes for table `cam_features`
--
ALTER TABLE `cam_features`
  ADD PRIMARY KEY (`product_code`);

--
-- Indexes for table `cam_info`
--
ALTER TABLE `cam_info`
  ADD PRIMARY KEY (`product_code`);

--
-- Indexes for table `cam_specs`
--
ALTER TABLE `cam_specs`
  ADD PRIMARY KEY (`product_code`);

--
-- Indexes for table `electrical_physical`
--
ALTER TABLE `electrical_physical`
  ADD PRIMARY KEY (`product_code`);
COMMIT;
